...
export default function AICoach() {
  ...
  const templates = [
    ...
    { label: 'Opponent Match & Batstat Analysis', text: 'Analyze our most recently scouted opponent match intelligence. How did Battrick grade and group their top order (#1-3), middle order (#4-6), and lower order tail (#7-11)? What does their Batstat number indicate about where their run scoring is concentrated, and how can we exploit their 5th bowler?' },
