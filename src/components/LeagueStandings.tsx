...
export const LeagueStandings: React.FC<LeagueStandingsProps> = ({ setActiveTab, onSelectScoutTeam }) => {
  ...
  const loadLocalData = () => {
    try {
      ...
      if (fcSaved && (fcSaved.includes('101') || fcSaved.includes('132175') || fcSaved.includes('Steve'))) {
      ...
      if (odSaved && (odSaved.includes('101') || odSaved.includes('132175') || odSaved.includes('Steve'))) {
      ...
      if (t20Saved && (t20Saved.includes('101') || t20Saved.includes('132175') || t20Saved.includes('Steve'))) {
